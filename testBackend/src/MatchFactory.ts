import { TDuration, TLobby, TMap, TMatchPlayer } from "./dependencies/lobbyTyping.js";
...
import { TMatchInRepo } from "./MatchRepository.js";

class MatchFactory {
    create(lobbySettings: TLobby, players: TMatchPlayer[]): TMatchInRepo {
    ...
    private _buildUserCustoms(settings: TLobby, players: TMatchPlayer[]): TUserCustoms {
